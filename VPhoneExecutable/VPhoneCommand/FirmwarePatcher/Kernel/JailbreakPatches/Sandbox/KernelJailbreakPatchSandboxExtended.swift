// KernelJailbreakPatchSandboxExtended.swift — JB kernel patch: Extended sandbox hooks bypass
//
...
extension KernelJailbreakPatcher {
    ...
    func patchSandboxHooksExtended() -> Bool {
        ...
        // On iOS 27, leave ops[267] real so KernelJailbreakPatchFpfsScopedOpen can retarget it to a
