// KernelJailbreakPatchProcSecurity.swift — JB: stub _proc_security_policy with mov x0,#0; ret.
//
...
//   See KernelJailbreakPatcherBase.findProcSecurityPolicy(). Stubbing its entry to
